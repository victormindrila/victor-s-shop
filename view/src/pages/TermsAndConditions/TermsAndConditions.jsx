			...
			<div className='cart-page container-fluid container-min-max-width'>
				...
				<ul>
					...
					<li>
						<p>
							...
							&quot;Our&quot; in this Agreement) refers to Victor's Shop.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Victor's Shop, accessible from{' '}
							<a href='www.victors-shop.com' rel='external nofollow noopener' target='_blank'>
								www.victors-shop.com
							</a>
						</p>
					</li>
					<li>
				...
				<ul>
					<li>
						...
						<a href='www.victors-shop.com/contact' rel='external nofollow noopener' target='_blank'>
							www.victors-shop.com/contact
						</a>
					</li>
				</ul>
			</div>
